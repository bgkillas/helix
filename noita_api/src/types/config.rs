...
pub struct ConfigExplosion {
    ...
    pub material_sparks_count: ValueRange<isize>,
...
pub struct ConfigGridCosmeticParticle {
    ...
    pub vel: Vec2<f32>,
    pub vel_random: AABB<f32>,
    pub color: Color,
    pub lifetime: ValueRange<f32>,

use crate::{AppConfigVTable, PlatformVTable, StdBox, StdString, StdVec, Vec2};
#[derive(Debug)]
#[repr(C)]
pub struct Platform {
    ...
    pub width: isize,
    pub height: isize,
    pub event_recorder: *const usize,
    pub mouse: *const usize,
    pub keyboard: *const usize,
    pub touch: *const usize,
    pub joysticks: StdVec<*const usize>,
    pub sound_player: *const usize,
...
pub struct AppConfig {
    pub vftable: StdBox<AppConfigVTable>,
    ...
    pub set_random_seed_cb: *const usize,
}
#[derive(Debug)]
#[repr(C)]
...
pub struct GraphicsSettings {
    ...
    pub external_graphics_context: *const usize,
}
